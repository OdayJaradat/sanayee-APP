...
abstract class _$$PhoneCodeSentImplCopyWith<$Res> {
  factory _$$PhoneCodeSentImplCopyWith(
    _$PhoneCodeSentImpl value,
    $Res Function(_$PhoneCodeSentImpl) then,
...
class __$$PhoneCodeSentImplCopyWithImpl<$Res>
    extends _$AuthStateCopyWithImpl<$Res, _$PhoneCodeSentImpl>
    implements _$$PhoneCodeSentImplCopyWith<$Res> {
  __$$PhoneCodeSentImplCopyWithImpl(
    _$PhoneCodeSentImpl _value,
    $Res Function(_$PhoneCodeSentImpl) _then,
  ) : super(_value, _then);
...
class _$PhoneCodeSentImpl implements _PhoneCodeSent {
  const _$PhoneCodeSentImpl(this.verificationId);
  ...
  @override
  String toString() {
    return 'AuthState.phoneCodeSent(verificationId: $verificationId)';
  }
...
abstract class _PhoneCodeSent implements AuthState {
  const factory _PhoneCodeSent(final String verificationId) =
      _$PhoneCodeSentImpl;
